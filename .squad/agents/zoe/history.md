...
- 📌 2026-04-27 (cross-agent): auth-entra session complete. Kaylee (kaylee-2) wired MSAL with matching authority and scope — frontend and backend auth config are now aligned. River confirmed 16/16 tests pass including authenticated endpoint flows.
